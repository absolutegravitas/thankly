          ...
          fields: [
            {
              ...
              fields: [
                ...
                // for guest checkout
                { name: 'subscribeToNewsletter', type: 'checkbox', required: false },
          ...
          fields: [
            {
              ...
              label: 'Items',
              type: 'array',
              // required: true, // doesn't export types as a proper array unless this is specified, but also messes up cart creation in frontend
              // minRows: 1,
              fields: [
