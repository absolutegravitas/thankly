...
import SplitAnimate from '@web/_components/SplitAnimate'
import { ArrowRightIcon } from '@web/_icons/ArrowRightIcon'
import { ChevronDownIcon } from '@web/_icons/ChevronDownIcon'
