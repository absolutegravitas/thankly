...
export const CartNotification: React.FC = () => {
  ...
  return (
    <div className="relative group">
      ...
      <div className="absolute top-3 right-0 mt-2 w-52 bg-neutral-100 border border-solid shadow-md rounded-sm hidden group-hover:block">
        <div className="px-6 py-6">
          ...
          <div className="my-4 font-semibold">
            Total:{' '}
            {cart.totals.total.toLocaleString('en-AU', { style: 'currency', currency: 'AUD' })}
          </div>
