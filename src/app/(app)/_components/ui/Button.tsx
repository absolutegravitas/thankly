...
const buttonVariants = cva(
  ...
  disabled:opacity-50 dark:ring-offset-zinc-950 dark:focus-visible:ring-blue-500/80`,
  {
    variants: {
      color: {
        default:
          'bg-zinc-900 text-zinc-50 hover:bg-zinc-900/90 dark:bg-zinc-50 dark:text-zinc-900 dark:hover:bg-zinc-50/80',
        red: 'bg-red-600 text-zinc-50 hover:bg-red-600/80 dark:bg-red-800 dark:text-white dark:hover:bg-red-900/90',
      },
      variant: {
        default: '',
        outline: [
