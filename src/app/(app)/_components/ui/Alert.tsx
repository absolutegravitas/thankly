...
const alertStyles = cva(['block rounded-md p-3 text-sm transition-all duration-300 ease-in-out'], {
  variants: {
    color: {
      ...
      yellow: 'bg-yellow-400 text-yellow-700 hover:bg-yellow-400/20 dark:bg-yellow-400/10',
      green:
        'bg-green-500 text-green-700 hover:bg-green-500/20 dark:bg-green-500/10 dark:text-green-600',
