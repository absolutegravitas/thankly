...
const Collapsible: React.FC<CollapsibleProps> = ({
  ...
  children = applyPropsToChildrenOfType(children, { context }, [
    CollapsibleContent,
    CollapsibleTrigger,
  ])
  return (
...
const CollapsibleTrigger: React.FC<CollapsibleTriggerProps> = ({
  ...
  <>
    ...
    <label
      ...
      ref={ref}
      className={cn(
        'collapsible group grid cursor-pointer select-none grid-flow-col grid-cols-[minmax(0,_1fr)_auto] items-center',
        className,
      )}
      {...props}
    >
